/* ==========================================================================
   In Smyle Dental — Lakeview & Roscoe Village — "Use It or Lose It" page
   - Google Ads / GA4 conversion event hooks
   - Live countdown to the Dec 31 benefits deadline (Chicago time)
...
(function () {
  ...
  var CONFIG = {
    PHONE_E164: '+17739156530',
    ADS_CONVERSION_ID: '',   // e.g. 'AW-123456789'
    LABEL_CALL: '',
    LABEL_BOOK: '',
    DEADLINE_ISO: '2026-12-31T23:59:59-06:00'   // America/Chicago (CST, benefits-deadline evening)
  };
  ...
  var HOURS = {
    1: [420, 1140],  // Mon  7:00a–7:00p
    2: [480, 1080],  // Tue  8:00a–6:00p
    3: [420, 1080],  // Wed  7:00a–6:00p
    4: [420, 1140],  // Thu  7:00a–7:00p
    5: null,         // Fri closed
    6: [420, 900],   // Sat  7:00a–3:00p
    0: null          // Sun closed
  };
  ...
  function initHours() {
    var now; try { now = chicagoNow(); } catch (e) { return; }
